  ...
  return (
    <Alert className="bg-amber-50 border-amber-300">
      ...
      <AlertDescription className="text-amber-800 flex flex-col md:flex-row md:items-center gap-2">
        <span>You can only see yourself in the employee list. This is likely due to a database permission issue or because no other employees have been created yet.</span>
